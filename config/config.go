...
var (
        ...
        ApiUrl              = getEnv("API_URL", "https://shrutibots.site")
        ...
        SupportGroup        = getEnv("SUPPORT_GROUP", "https://t.me/Secret_Auraa")
        SupportChannel      = getEnv("SUPPORT_CHANNEL", "https://t.me/Secret_Auraa")
        
        // Yahan maine aapka diya hua image link add kar diya hai
        StartImg            = getEnv("START_IMG", "https://h.uguu.se/DtWgHHDe.jpg") 
